...
// Other settings
#define OW_POISON_DAMAGE                GEN_5      // In Gen4, Pokémon no longer faint from Poison in the overworld. In Gen5+, they no longer take damage at all.
...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_HIDE_FOLLOWERS // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FLAG_PAUSE_TIME          FLAG_FREEZE_TIME  // If this flag is set and OW_USE_FAKE_RTC is enabled, seconds on the in-game clock will not advance.
